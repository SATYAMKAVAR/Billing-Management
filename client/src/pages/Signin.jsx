...
const Signin = () => {
  ...
  const handleActiveEmail = async (e) => {
    try {
      ...
      closeModal();
      setActiveEmail({ email: "", otp: "", forActive: true });
    } catch (error) {
      toast.error(error.message, {
        id: notifiyloading,
        style: { background: "red", color: "white" },
    ...
    <div>
      ...
      <div className="max-w-lg mx-auto bg-slate-500 rounded mt-44 p-8">
        ...
        <div className="flex gap-2 mt-5">
          ...
          <Link to={"/sign-up"}>
            <span className="text-white font-mono">Sign up</span>
          </Link>
        </div>
        <div className="flex gap-2 mt-5">
          ...
          {/* <Link to={"/sign-up"}> */}
          <span
            className="text-white hover:cursor-pointer font-mono"
            onClick={openModal}
          >
            Activate
          </span>
        ...
        {showModal && (
          <div className="fixed  inset-0 z-10 overflow-y-auto">
            <div className="flex items-end  justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
              ...
              <div className="inline-block align-bottom bg-slate-600 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div className=" px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <span className="text-2xl">
                    {showOTP && `We send you OTP on your ${activeEmail.email}`}
                  </span>
                ...
                <div className="bg-slate-600 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                  <button
                    type="button"
